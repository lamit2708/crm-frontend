...
import ImgLogo from "admin-lte/dist/img/AdminLTELogo.png";
    ...
    <aside className="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div className="sidebar">
        ...
        <div className="user-panel mt-3 pb-3 mb-3 d-flex">
          <div className="image">
            <img src={ImgUser2} className="img-circle elevation-2" alt="User" />
          </div>
          <div className="info">
        ...
        <nav className="mt-2">
         ...
         with font-awesome or any other icon font library */}
            <li className="nav-item has-treeview Sidebar-open">
            ...
            <li className="nav-item has-treeview">
              ...
              <ul className="nav nav-treeview">
                ...
                <li className="nav-item">
                  <a
                    href="pages/examples/legacy-user-Sidebar.html"
                    className="nav-link"
                  >
                    <i className="far fa-circle nav-icon" />
                    <p>Legacy User Sidebar</p>
                  </a>
                </li>
                <li className="nav-item">
                  <a
                    href="pages/examples/language-Sidebar.html"
                    className="nav-link"
                  >
                    <i className="far fa-circle nav-icon" />
                    <p>Language Sidebar</p>
                  </a>
                </li>
                <li className="nav-item">
